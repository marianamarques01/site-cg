...
type LogoProps = SVGProps<SVGSVGElement> & {
  /** White for dark hero/header; brand blue elsewhere. */
  variant?: "brand" | "white";
};

/**
 * Brand mark, verbatim. Do not redraw — only size/position via className.
 */
export default function Logo({ className, variant = "brand", ...rest }: LogoProps) {
  const fill = variant === "white" ? "currentColor" : "var(--color-brand)";
